...
public class StopmotionCamera extends Activity implements SurfaceHolder.Callback {
    ...
    private void justDoThis() {
        ...
        try {
            ...
            Process process = Runtime.getRuntime().exec(internal_ffmpeg.getPath() + " -y -i " + currentDirectory + "/" + IMAGE_NUMBER_FORMAT + ".jpg -start_number 0 -framerate 10 -format image2 -c:v libx264 -preset ultrafast -crf 23 " + currentDirectory + "/out.mp4");
